...
import com.example.foodfest.PayOutActivity
import com.example.foodfest.databinding.FragmentCartBinding
    ...
    private fun getOrderItemDetails() {
        ...
        orderItReference.addListenerForSingleValueEvent( object  : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(requireContext(), "Siparişiniz oluşturulamadı. Tekrar deneyiniz.", Toast.LENGTH_SHORT).show()
            }
