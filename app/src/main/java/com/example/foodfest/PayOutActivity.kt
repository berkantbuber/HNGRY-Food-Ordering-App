...
import com.example.foodfest.databinding.ActivityPayOutBinding
...
//        binding.totalAmount.isEnabled= false
        ...
        binding.placeOrder.setOnClickListener {
            ...
            if (names.isBlank() && address.isBlank() && numbers.isBlank()){
                ...
                Toast.makeText(this, "Lütfen tüm ayrıntıları girin", Toast.LENGTH_SHORT).show()
            }else{
                placeOrder()
            }
    ...
    private fun placeOrder() {
        ...
        orderReference.setValue(orderDetails).addOnSuccessListener {
            ...
            .addOnFailureListener {
                Toast.makeText(this, "Sipariş başarısız oldu", Toast.LENGTH_SHORT).show()
            }
    }
